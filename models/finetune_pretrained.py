...
class PretrainedFeatureExtractor(nn.Module):
    ...
    def __init__(self, freeze_weight, img_size):
...
class FinetuneEfficientNetB7FeatureExtractor(PretrainedFeatureExtractor):
    ...
    def __init__(self, freeze_weight=False, img_size=16):
...
class FinetuneEfficientNetB7(nn.Sequential):
    ...
    def __init__(self, num_classes, dropout_rate=0.5, freeze_weight=False, img_size=16):
        super().__init__(
...
class FinetuneEnsembleModel(nn.Module):
    def __init__(self, num_classes, device, dropout_rate=0.5, freeze_weight=False, img_size=16):
